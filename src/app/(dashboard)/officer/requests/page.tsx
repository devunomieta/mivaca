    ...
    <div className="animate-fade-in">
      <div className="page-header">
        <div>
          ...
          <p className="text-brand-gray text-sm">{total} total tasks assigned to you</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-border shadow-card overflow-hidden">
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-brand-navy font-medium">No tasks found</p>
            <p className="text-brand-gray text-sm mt-1">You have no tasks matching this filter.</p>
          </div>
        ) : (
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-brand-canvas border-b border-border">
                  {['ID', 'Title', 'Category', 'Location', 'Requester', 'Priority', 'Status', 'Submitted'].map((h) => (
                ...
                {requests.map((req: any) => {
                  return (
                    <tr key={req.id} id={`row-${req.id}`} className="hover:bg-brand-canvas/50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-sm text-brand-gray whitespace-nowrap truncate max-w-[150px]">
                        {req.location}
                      </td>
